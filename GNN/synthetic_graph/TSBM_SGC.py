...
while sleep 1; do python TSBM_SGC.py --L 3 --epoch 200; done
while sleep 1; do python TSBM_SGC.py --L 4 --epoch 200; done



while sleep 1; do python TSBM_SGC.py --L 5 --epoch 200; done
