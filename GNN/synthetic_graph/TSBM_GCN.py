...
while sleep 1; do python TSBM_GCN.py --L 0 --decay 0.4 --epoch 200; done
while sleep 1; do python TSBM_GCN.py --L 0 --decay 0.5 --epoch 200; done
while sleep 1; do python TSBM_GCN.py --L 0 --decay 0.6 --epoch 200; done
while sleep 1; do python TSBM_GCN.py --L 0 --decay 0.7 --epoch 200; done
while sleep 1; do python TSBM_GCN.py --L 3 --epoch 200; done
while sleep 1; do python TSBM_GCN.py --L 4 --epoch 200; done



while sleep 1; do python TSBM_GCN.py --L 5 --epoch 200; done
while sleep 1; do python TSBM_GCN.py --L 0 --decay 0.45 --epoch 200; done
while sleep 1; do python TSBM_GCN.py --L 0 --decay 0.55 --epoch 200; done
while sleep 1; do python TSBM_GCN.py --L 0 --decay 0.65 --epoch 200; done
while sleep 1; do python TSBM_GCN.py --L 0 --decay 0.75 --epoch 200; done
while sleep 1; do python TSBM_GCN.py --L 0 --decay 0.8 --epoch 200; done
