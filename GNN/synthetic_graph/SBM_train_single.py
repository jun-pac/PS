...
if __name__ == "__main__":
    ...
    print(f"Training GCN (single layer) ; {args.dataset}")    
    ...
    f_log=open('./txtlog_single/'+args.dataset+'.txt','a')
    ...
    print(f"Test accuracy ({args.epoch} epoch) {acc:.4f}")
    f_log.write("{:.4f}\n".format(acc))
    f_log.flush()
